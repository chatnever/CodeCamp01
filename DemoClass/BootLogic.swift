...
class BootLogic: NSObject {
    ...
    class func boot(window:UIWindow){
        ...
        var codecamp = [SECTION: "Code Camp", MENU: [
            [TITLE: "1. Average Of Array", CLASS: "ArrayAverage"],
            [TITLE: "2. Mang Khong Lap", CLASS: "NonDuplicateArray"],
            [TITLE: "3. Footballer", CLASS: "Footballer"],
            [TITLE: "4. Even and Odd", CLASS: "ArrangeEvenVSOdd"],
            [TITLE: "5. Average Of Complex", CLASS: "ComplexAverage"],
            ]
            
        ]
    
        mainScreen.menu = [codecamp, basic, function, collection, advanced]
